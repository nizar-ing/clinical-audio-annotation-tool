...
const rendering = ref<'digits' | 'words' | 'mixed'>('words');
...
<template>
  ...
  >
    <label class="flex flex-col gap-1 text-xs font-sans font-semibold uppercase tracking-widest text-warm-500">
      ...
      >
        <option value="digits">Digits (e.g. "1500")</option>
        <option value="words">Words (e.g. "eintausendfuenfhundert")</option>
